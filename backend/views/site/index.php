...
<h2>Usuarios</h2>
<p>
Este es el lugar para administrar usuarios. Puede editar estados y roles
desde aquí.
La IU es fácil de usar e intuitiva, simplemente haga clic en el link de abajo
para comenzar.
</p>
<p>
<?php
...
<p>
Aquí es donde administra Roles. Puede decidir quién es admin y
quién no. Puede añadir un nuevo rol, simplemente haciendo clic en el link de
abajo para comenzar.
</p>
<p>
<?php
...
Estos son fáciles de administrar via IU. Simplemente haga clic en el link de
abajo para administrar perfiles.
</p>
<p>
<?php
if (!Yii::$app->user->isGuest && $is_admin) {
